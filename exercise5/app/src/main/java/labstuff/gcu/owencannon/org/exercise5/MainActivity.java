package labstuff.gcu.owencannon.org.exercise5;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        TextView tbox1 = (TextView)findViewById(R.id.salutation);
        salutation.setTextColor(getResources().getColor(R.color.black,null));
        salutation.setTypeface(Typeface.SANS_SERIF);
